                ...
                <div class="row">
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            ...
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">수정</a>
                            </li>
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none" href="#">삭제</a>
                            </li>
                        </ul>
                    </div>
                    ...
                    <div>
						...
						<form name=f1 action="./ProdController.pr"
							  ...
							  <table border=1 id=tabel4>
							  	<tr><td>도서번호(수정불가)</td><td><input type="text" name="p_id" value="<%=prod.getP_id() %>" readonly></td></tr>
							  	...
							  	<input type="hidden" name="actionType" value="U_ID">
							  </table>
						</form>
                    </div>
                </div>
