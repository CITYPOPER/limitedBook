                ...
                <ul class="list-unstyled templatemo-accordion">
                    <li class="pb-3">
                        ...
                        <ul class="collapse show list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">a1</a></li>
                            <li><a class="text-decoration-none" href="#">a2</a></li>
                        </ul>
                    </li>
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                        ...
                        <ul id="collapseTwo" class="collapse list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">b1</a></li>
                            <li><a class="text-decoration-none" href="#">b2</a></li>
                        </ul>
                    </li>
                    <li class="pb-3">
                        <a class="collapsed d-flex justify-content-between h3 text-decoration-none" href="#">
                        ...
                        <ul id="collapseThree" class="collapse list-unstyled pl-3">
                            <li><a class="text-decoration-none" href="#">c1</a></li>
                            <li><a class="text-decoration-none" href="#">c2</a></li>
                            <li><a class="text-decoration-none" href="#">c3</a></li>
                        </ul>
                    </li>
                </ul>
            </div>
                    ...
                    <div class="col-md-6">
                        <ul class="list-inline shop-top-menu pb-3 pt-1">
                            <li class="list-inline-item">
                                <a class="h3 text-dark text-decoration-none mr-3" href="#">조회</a>
                            </li>
                            <li class="list-inline-item">
...
<%-- 									<tr>
			                    ...
			                    <div class="col-md-4">
			                        <div class="card mb-4 product-wap rounded-0">
			                            <div class="card rounded-0">
			                                <img class="card-img rounded-0 img-fluid" src="<%=imageDir%><%=prod.getP_img()%>">
			                                <div class="card-img-overlay rounded-0 product-overlay d-flex align-items-center justify-content-center">
			                                    <ul class="list-unstyled">
			                                        <!-- <li><a class="btn btn-success text-white" href="shop-single.jsp"><i class="far fa-heart"></i></a></li>
			                                        <li><a class="btn btn-success text-white mt-2" href="shop-single.jsp"><i class="far fa-eye"></i></a></li> -->
			                            ...
			                            <div class="card-body">
			                                <ul class="list-unstyled pb-3">
				                                <li>도서명:<%=prod.getP_name()%></li>
				                                <li>등록날짜:<%=prod.getP_date()%></li>
				                            </ul>
			                                <ul class="w-100 list-unstyled d-flex justify-content-between mb-0">
			                                    <li><a href="./ProdController.pr?actionType2=U2&p_id=<%=prod.getP_id()%>">UPDATE</a></li>
			                                    <li><a href="./ProdController.pr?actionType2=D_ID&p_id=<%=prod.getP_id()%>">DELETE</a></li>
			                                    <li class="pt-2">
			                                        <span class="product-color-dot color-dot-red float-left rounded-circle ml-1"></span>
			                                        <span class="product-color-dot color-dot-blue float-left rounded-circle ml-1"></span>
			                                        <span class="product-color-dot color-dot-black float-left rounded-circle ml-1"></span>
